    ...
    <div className="container-fluid h-100">
      <div className="row h-100">
        ...
        <div className="col-md-6 " style={{ color:'#32395F',height: '100vh', backgroundImage: `url('https://img.freepik.com/free-photo/doctor-working-with-laptop_23-2147646059.jpg?t=st=1715265775~exp=1715269375~hmac=686c3046a58bd0d4792a22069548aadd88b612c72ec9840951f393b35411c26c&w=740')`, backgroundSize: 'cover' }}>
          <div className="d-flex justify-content-between mx-5 mt-4">
            ...
            <div className="d-flex align-items-center justify-content-between">
              <p className="me-3" style={{ backgroundColor: '#007dbf', borderRadius: '50%', width: '50px', height: '50px', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
        ...
        <div className="col-md-6 h-100">
          <div className=" mt-5" style={{ margin: '0 90px'}}>
            <div className="row">
              <div className="col">
                {/* Section 1 */}
            ...
            <div className="row  rounded" style={{ backgroundColor: '#E2F1F8' }}>
              <div className="col">
                {/* Section 2 */}
                <div className="d-flex justify-content-between align-items-center justify-content-center px-4 py-3">
                  <div className="d-flex row justify-content-between align-items-center fs-6">
                    <p className="mb-0 fs-2 " style={{ fontWeight: 600, color:'#32395F' }}>09:00</p>
                    <p className="mb-0" style={{ fontWeight: 600, color:'#32395F', fontSize:'14px' }}>Une fois | <span className="" style={{ fontWeight: 600, color:'#708090', fontSize:'14px' }}>Alert dans 02h30min</span></p>
                  </div>
                  <div className="form-check form-switch">
                    ...
                    <label className="form-check-label" htmlFor="switch1" style={{ cursor: 'pointer' }}>
                      <div className="switch" style={{ width: '50px', height: '30px', borderRadius: '15px', position: 'relative', backgroundColor: '#ccc' }}>
            ...
            <div className="row mt-4 rounded" style={{ backgroundColor: '#E2F1F8' }}>
              <div className="col">
                {/* Section 2 */}
                <div className="d-flex justify-content-between align-items-center justify-content-center px-4 py-3">
                  <div className="d-flex row justify-content-between align-items-center fs-6">
            ...
            <span class="d-block border-bottom border-muted border-1 mt-5 mb-4"></span>
            <div className="row">
              {/* <div className="d-flex row align-items-center justify-content-center"> */}
                <div className="d-flex justify-content-between align-items-center fs-5">
                  <p style={{ fontWeight: 600, color:'#32395F' }}>
                ...
                <div className="d-flex justify-content-between">
                  <div
                    className="d-flex justify-content-between fs-4 rounded py-3 me-3"
                    style={{
                      cursor: 'pointer',
                  ...
                  >
                    <div className="d-flex row mx-2 fs-4">
                      <div className="d-flex justify-content-between align-items-center w-100 pb-3">
                        <p className="m-0" style={{ fontSize: '13px', color:'#32395F', fontWeight: 600}}>Petite notification</p>
                        <input type="checkbox" style={{ transform: `scale(${scale})` }} />
                      </div>
                      <div className="pe-5" style={{ height: '160px' }}>
                        <div class="card rounded h-100">
                          ...
                          <div class="d-flex justify-content-end align-items-end ps-5 pe-3 mb-3 h-100" style={{ height: '5px' }}>
                            <div class="card-body bg-warning rounded" style={{ minHeight: '10px' }}>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  >
                    <div className="d-flex row justify-content-between mx-2 fs-4">
                      <div className="d-flex justify-content-between align-items-center w-100 pb-3">
                        <p className="m-0" style={{ fontSize: '13px', color:'#32395F', fontWeight: 600}}>Grande notification</p>
                        <input type="checkbox" style={{ transform: `scale(${scale})` }} />
                      </div>
                      <div className="pe-5" style={{ height: '160px' }}>
                        <div class="card rounded h-100">
                          ...
                          <div class="px-5 h-100 d-flex align-items-center">
            ...
            <span class="d-block border-bottom border-muted border-1 my-5"></span>
            <div class="row px-2"> 
              <button class="btn btn-lg  rounded text-white py-3" style={{ backgroundColor: '#007dbf' }}>ENREGISTER LA NOTIFICATION</button>
            </div>
          </div>
